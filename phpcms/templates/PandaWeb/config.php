<?php return array (
  'name' => 'PanDaWeb',
  'author' => 'Simplee',
  'dirname' => 'PandaDesign2012',
  'homepage' => 'http://www.90-designer.com',
  'version' => '3.2.0',
  'disable' => 0,
  'file_explan' => 
  array (
    ...
    'templates|PandaWeb|content' => 
    array (
      'category.html' => '分类',
      'footer-rss.html' => 'rss页脚',
      'footer.html' => '页脚',
      'header.html' => '页头',
      'header_min.html' => '页头（迷你）',
      'index.html' => '主页',
      'list.html' => '列表页',
      'list_download.html' => '列表页（下载）',
      'list_picture.html' => '列表页（图片）',
      'page.html' => '分页',
      'right.html' => '右侧',
      'rss.html' => 'rss',
      'search.html' => '搜索',
      'show.html' => '内容',
      'show_download.html' => '内容（下载）',
      'show_picture.html' => '内容（图片）',
      'tag.html' => '标签',
    ),
  ),
);?>