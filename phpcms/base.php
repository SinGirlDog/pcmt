...
//PDW静态资源路径
define('JS_PATH_PDW','http://'.$_SERVER['HTTP_HOST'].'/statics_PDW/js/');
define('CSS_PATH_PDW','http://'.$_SERVER['HTTP_HOST'].'/statics_PDW/css/');
define('IMG_PATH_PDW','http://'.$_SERVER['HTTP_HOST'].'/statics_PDW/images/');

//Black静态资源路径
define('JS_PATH_BLACK','http://'.$_SERVER['HTTP_HOST'].'/statics_Black/js/');
define('CSS_PATH_BLACK','http://'.$_SERVER['HTTP_HOST'].'/statics_Black/css/');
define('IMG_PATH_BLACK','http://'.$_SERVER['HTTP_HOST'].'/statics_Black/images/');

//XHC静态资源路径
define('JS_PATH_XHC','http://'.$_SERVER['HTTP_HOST'].'/statics_XHC/js/');
define('CSS_PATH_XHC','http://'.$_SERVER['HTTP_HOST'].'/statics_XHC/css/');
define('IMG_PATH_XHC','http://'.$_SERVER['HTTP_HOST'].'/statics_XHC/images/');
