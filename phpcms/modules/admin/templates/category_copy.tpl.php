...
<form name="myform" id="myform" action="?m=admin&c=category&a=copy" method="post">
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
      ...
      <tr>
        <th width="200">复制到：</th>
        <td>
		<?php echo form::select_category('category_content_'.$this->siteid,$parentid,'name="toid"','请选择复制到栏目',0,-1);?>
		注意：不选择将会新建一个新栏目</td>
      </tr>
      <tr>
        <th><?php echo L('catname')?>：</th>
        <td><input type="text" name="info[catname]" id="catname" class="input-text" value="<?php echo $catname;?>-副本"></td>
      </tr>
	<tr>
        <th><?php echo L('catdir')?>：</th>
        <td><input type="text" name="info[catdir]" id="catdir" class="input-text" value="<?php echo $catdir;?>-copy"></td>
      </tr>
	<tr>
...
<tr>
 ...
 <div class="bk15"></div>
    ...
    <input name="dosubmit" type="submit" value="<?php echo L('submit')?>" class="button">注意：复制后子栏目模型、模版、权限等设置将继承本页设置。
